...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Fh(){return new _i({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fl(),fragmentShader:`
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Bh(){return new _i({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fl(),fragmentShader:`
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function fl(){return`
...
`].filter(rr).join(`
`)),o=Pc(o),o=jh(o,t),o=$h(o,t),a=Pc(a),a=jh(a,t),a=$h(a,t),o=Kh(o),a=Kh(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+p);const x=T+m+o,A=T+p+a,H=Xh(s,s.VERTEX_SHADER,x),w=Xh(s,s.FRAGMENT_SHADER,A);s.attachShader(v,H),s.attachShader(v,w),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function P(W){if(n.debug.checkShaderErrors){const J=s.getProgramInfoLog(v).trim(),U=s.getShaderInfoLog(H).trim(),Z=s.getShaderInfoLog(w).trim();let ne=!0,ie=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(ne=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,H,w);else{const oe=qh(s,H,"vertex"),V=qh(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
